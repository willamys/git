...
public class ServicoListarActivity extends Activity{


	public static final String tag = "ServicoListarActivity";
		TextView tviewColumnIdServico;
	TextView tviewColumnNome;
	TextView tviewColumnIdCategoria;
	long aux;
	TableRow row;
	TableLayout tableLayout;
	ArrayList<ServicoVO> arrayServico = new ArrayList<ServicoVO>();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.servicolistaractivity);
		clearTable();
		createTable();
		addBotaoVoltar();
	}
...
arrayServico = Fachada.getInstance().getAllServico(this);
		
		tviewColumnIdServico = (TextView) findViewById(R.id.TextViewidServico);
		tviewColumnIdServico.setTextSize(10f);
		tviewColumnIdServico.setLines(2);
...
if(arrayServico.size() > 0 && arrayServico != null){
			for (int i = 0; i < arrayServico.size(); i++) {
				...
				tview1.setText(String.valueOf(arrayServico.get(i).idServico));
				tview1.setTag("view1"+arrayServico.get(i));
				tview1.setMaxWidth(5);
								//**coluna2
				TextView tview2 = new TextView(this);
				tview2.setTextSize(12);
				tview2.setPadding(0, 0, 5, 0);
				tview2.setText(String.valueOf(arrayServico.get(i).nome));
				tview2.setTag("view2"+arrayServico.get(i));
				tview2.setMaxWidth(5);
								//**coluna3
				TextView tview3 = new TextView(this);
				tview3.setTextSize(12);
				tview3.setPadding(0, 0, 5, 0);
				tview3.setText(String.valueOf(arrayServico.get(i).idCategoria));
				tview3.setTag("view3"+arrayServico.get(i));
				...
				update.setHeight(5);
				update.setWidth(5);
				update.setTag("view${velocityCount}"+arrayServico.get(i));
			update.setId(arrayServico.get(i).  idServico);  				
				update.setOnClickListener(new View.OnClickListener()
				{
					public void onClick(View v) {
						Log.i(tag, "on click " + update.getId());
						Intent i =  new Intent(ServicoListarActivity.this, ServicoAlterarActivity.class);
				...
				delete.setHeight(5);
				delete.setWidth(5);
				delete.setTag("view${velocityCount}"+arrayServico.get(i));
			delete.setId(arrayServico.get(i).  idServico);  				
		...
		new AlertDialog.Builder(this).setTitle(this.getResources()
				...
				new android.content.DialogInterface.OnClickListener(){
							public void onClick(DialogInterface arg0,
									int arg1) {
								String message = "";
								long ret = Fachada.getInstance().deleteServico(ServicoListarActivity.this, aux);
								if( ret != -1 && ret != 0){
